...
function register(){
	...
	var addressRegister = true;
    if(address==""){
        document.getElementById('address-valid').innerHTML="Address must be filled!";
    ...
    if(nameRegister && emailRegister && genderRegister && cityRegister && addressRegister && passRegister && confpassRegister){
